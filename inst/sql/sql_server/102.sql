...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (4029488,194417,4337543,4159144,196455,197676,201065,194984,4245975,194990,193355,4055224)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (4029488,194417,4337543,4159144,196455,201065,4245975,4055224)
  and c.invalid_reason is null

) I
LEFT JOIN
(
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (4314443,46270037,46269818,46269836,4308946,46270152,46270142,43530913,36716708,763021,439675,196029,194856,200031,439672,36716709,4059299,4055225,4059298,4340390,3655440,4248427)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (4314443,46270037,46269818,46269836,4308946,46270152,46270142,43530913,36716708,763021,439675,196029,194856,200031,439672,36716709,4059299,4055225,4059298,4340390,3655440,4248427)
  and c.invalid_reason is null
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (44825528,45528088,44828810,44837179,44831598,44825529,44831608,44822314,44824335,44822042)

) I
) C UNION ALL 
SELECT 3 as codeset_id, c.concept_id FROM (select distinct I.concept_id FROM
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (3035995,3021952,3035400)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (3035995,3021952,3035400)
  and c.invalid_reason is null
...
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (3006923)
  and c.invalid_reason is null
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (201901,4340383,200762,200763,201613,4064161,200616,4340951,4341657,4246127,199837,4059290,42537742,197494)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (201901,4340383,200762,200763,201613,4064161,200616,4340951,4341657,4246127,199837,4059290,42537742,197494)
  and c.invalid_reason is null
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (3024128,3006140,46235782)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (3024128,3006140,46235782)
  and c.invalid_reason is null
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (201901,37311131,46269816,46269817,200762,37016176,4340390,4212540,318773,36714559,45769564,4042860,45757783,4058714,44788726,44788725,4163735,46269836,196029,4331292,40484946,43021368,4130518,4093637,435140,4291005,4229262)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (201901,37311131,46269816,46269817,200762,37016176,4340390,4212540,318773,36714559,45769564,4042860,45757783,4058714,44788726,44788725,4163735,46269836,196029,4331292,40484946,43021368,4130518,4093637,435140,4291005,4229262)
  and c.invalid_reason is null
...
WHERE C.value_as_number >= 48.0000
...
WHERE C.value_as_number > 2.8100
...
WHERE C.value_as_number <= 24.0000
AND C.unit_concept_id in (4120726)
-- End Measurement Criteria
